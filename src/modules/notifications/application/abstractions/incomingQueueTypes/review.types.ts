...
export type ReviewEventName =
  (typeof reviewEventNames)[keyof typeof reviewEventNames];

export type ReviewEvent =
  | {
      type: typeof reviewEventNames.new_review_received;
      payload: SingleRecipientPayload;
    }
  | {
      type: typeof reviewEventNames.new_review_created;
      payload: SingleRecipientPayload;
    }
  | {
      type: typeof reviewEventNames.review_edited;
      payload: SingleRecipientPayload;
    };
